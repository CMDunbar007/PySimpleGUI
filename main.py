...
def create_window():
    ...
    layout = [
        ...
        [sg.VPush()],
        [sg.Text('', font = 'Tahoma 40', key = '-TIME-')],
        [
            sg.Button('Start', button_color = '#FF0000', border_width = 0, key = '-STARTSTOP-'),
            sg.Button('Lap', button_color = '#FF0000', border_width = 0, key = '-LAP-', visible = False)
        ],
        [sg.Column([[]], key = '-LAPS-')],
        [sg.VPush()]
    ]
